...
1. Clone the repo
```shell
    git clone https://github.com/Propero-Consulting/discount-app.git
```
2. Change Branch
```shell
    git fetch --all
...
```shell
    shopify app dev
```
**If you make any changes please read this**
1. Check todo file and add/delete/mark done the task you feel like they need to be added or removed when done.
2. If you add any task, do it under your name (example provided in the file).
